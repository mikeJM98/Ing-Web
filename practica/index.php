...
<body>
	<div class="container">
		<div class="row">
			...
			<input type="button" class="btn bg-primary text-white"></div>
			<input type="button" class="col-1 bg-secondary text-white"></div>
			<input type="button" class="col-1 bg-success text-white"></div>
			<input type="button" class="col-1 bg-danger text-white"></div>
		</div>
